...
src_install() {
	...
	keepdir /etc/victoria-metrics

	newdoc deployment/docker/auth-vm-cluster.yml vmauth.yml
	newdoc deployment/docker/prometheus-vm-cluster.yml vmagent.yml
	newdoc deployment/docker/rules/alerts-single-node.yml vmalert-single.yml
	newdoc deployment/docker/rules/alerts-cluster.yml vmalert-cluster.yml
	newdoc deployment/docker/rules/alerts-health.yml vmalert-health.yml
	newdoc deployment/docker/rules/alerts-vmagent.yml vmalert-vmagent.yml
	newdoc deployment/docker/rules/alerts-vmalert.yml vmalert-vmalert.yml
	newdoc deployment/docker/rules/alerts-vmanomaly.yml vmalert-vmanomaly.yml
	newdoc deployment/docker/rules/alerts-vmauth.yml vmalert-vmauth.yml
